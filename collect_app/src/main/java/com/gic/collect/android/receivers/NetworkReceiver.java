package com.gic.collect.android.receivers;
...
import com.gic.collect.android.activities.NotificationActivity;
import com.gic.collect.android.preferences.GeneralSharedPreferences;
import com.gic.collect.android.tasks.InstanceGoogleSheetsUploader;
...
public class NetworkReceiver extends BroadcastReceiver implements InstanceUploaderListener {
    ...
    private void uploadForms(Context context) {
        if (!running) {
            ...
            if (protocol.equals(context.getString(com.gic.collect.android.R.string.protocol_google_sheets))) {
    ...
    public void uploadingComplete(HashMap<String, String> result) {
        ...
        message
                .append(Collect.getInstance().getString(com.gic.collect.android.R.string.odk_auto_note))
                .append(" :: \n\n");

        if (result == null) {
            message.append(Collect.getInstance().getString(com.gic.collect.android.R.string.odk_auth_auth_fail));
        } else {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(Collect.getInstance())
                .setSmallIcon(com.gic.collect.android.R.drawable.notes)
                .setContentTitle(Collect.getInstance().getString(com.gic.collect.android.R.string.odk_auto_note))
