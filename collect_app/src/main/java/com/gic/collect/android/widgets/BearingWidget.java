...
import com.gic.collect.android.activities.BearingActivity;
...
public class BearingWidget extends QuestionWidget implements BinaryWidget {
    ...
    public BearingWidget(Context context, FormEntryPrompt prompt) {
        ...
        getBearingButton = getSimpleButton(getContext().getString(com.gic.collect.android.R.string.get_bearing));
        ...
        if (s != null && !s.equals("")) {
            getBearingButton.setText(getContext().getString(
                    com.gic.collect.android.R.string.replace_bearing));
            setBinaryData(s);
        }
    ...
    public void clearAnswer() {
        ...
        getBearingButton.setText(getContext()
                .getString(com.gic.collect.android.R.string.get_bearing));
    }
