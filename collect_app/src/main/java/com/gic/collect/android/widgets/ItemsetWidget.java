    ...
    protected ItemsetWidget(Context context,
        ...
        for (int i = 0; i < arguments.size(); i++) {
            ...
            try {
                ...
                error.setText(String.format(getContext().getString(com.gic.collect.android.R.string.parser_exception), arguments.get(i)));
                addAnswerView(error);
                break;
            }
        ...
        if (itemsetFile.exists()) {
                        ...
                        if (this.autoAdvanceToNext) {
                            ...
                            rightArrow.setImageBitmap(
                                    BitmapFactory.decodeResource(getContext().getResources(),
                                            com.gic.collect.android.R.drawable.expander_ic_right));
            ...
            TextView error = new TextView(context);
            error.setText(
                    getContext().getString(com.gic.collect.android.R.string.file_missing, itemsetFile.getAbsolutePath()));
            addAnswerView(error);
        }
