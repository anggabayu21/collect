...
package com.gic.collect.android.external;

import com.gic.collect.android.application.Collect;
import com.gic.collect.android.exception.ExternalDataException;
import com.gic.collect.android.external.handler.ExternalDataHandlerSearch;
...
import com.gic.collect.android.exception.InvalidSyntaxException;
                    ...
                    if (xpathFuncExpr.id.name.equalsIgnoreCase(
                        ...
                        if (xpathFuncExpr.args.length == 1 || xpathFuncExpr.args.length == 4
                            ...
                            throw new InvalidSyntaxException(Collect.getInstance().getString(
                                    com.gic.collect.android.R.string.ext_search_wrong_arguments_error));
                        }
                    } else {
                        // this might mean a problem in the regex above. Unit tests required.
                        throw new InvalidSyntaxException(Collect.getInstance().getString(
                                com.gic.collect.android.R.string.ext_search_wrong_function_error, xpathFuncExpr.id.name));
                    }
                } else {
                    // this might mean a problem in the regex above. Unit tests required.
                    throw new InvalidSyntaxException(
                            Collect.getInstance().getString(com.gic.collect.android.R.string.ext_search_bad_function_error,
                                    function));
                }
            } catch (XPathSyntaxException e) {
                throw new InvalidSyntaxException(
                        Collect.getInstance().getString(com.gic.collect.android.R.string.ext_search_generic_error,
                                appearance), e);
            }
        } else {
            return null;
                ...
                if (isAnInteger(value)) {
                    ...
                    if (eval.getClass().isAssignableFrom(ArrayList.class)) {
                        ...
                        throw new ExternalDataException(
                                Collect.getInstance().getString(com.gic.collect.android.R.string.ext_search_return_error,
