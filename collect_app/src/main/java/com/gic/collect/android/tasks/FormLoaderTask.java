...
import com.gic.collect.android.database.ItemsetDbAdapter;
import com.gic.collect.android.external.ExternalAnswerResolver;
import com.gic.collect.android.external.ExternalDataHandler;
import com.gic.collect.android.external.ExternalDataManager;
import com.gic.collect.android.external.ExternalDataManagerImpl;
import com.gic.collect.android.external.ExternalDataReader;
import com.gic.collect.android.external.ExternalDataReaderImpl;
import com.gic.collect.android.external.handler.ExternalDataHandlerPull;
import com.gic.collect.android.listeners.FormLoaderListener;
import com.gic.collect.android.logic.FileReferenceFactory;
import com.gic.collect.android.logic.FormController;
import com.gic.collect.android.utilities.FileUtils;
import com.gic.collect.android.utilities.ZipUtils;
...
public class FormLoaderTask extends AsyncTask<String, String, FormLoaderTask.FECWrapper> {
    ...
    protected FECWrapper doInBackground(String... path) {
        ...
        publishProgress(
                Collect.getInstance().getString(com.gic.collect.android.R.string.survey_loading_reading_form_message));
        ...
        if (csvFiles != null) {
            ...
            if (externalDataMap.size() > 0) {
                ...
                publishProgress(Collect.getInstance()
                        .getString(com.gic.collect.android.R.string.survey_loading_reading_csv_message));
    ...
    public boolean importData(File instanceFile, FormEntryController fec) {
        publishProgress(
                Collect.getInstance().getString(com.gic.collect.android.R.string.survey_loading_reading_data_message));
