...
package com.gic.collect.android.views;
...
import com.gic.collect.android.external.ExternalAppsUtils;
...
import com.gic.collect.android.exception.ExternalParamsException;
import com.gic.collect.android.utilities.ToastUtils;
import com.gic.collect.android.widgets.WidgetFactory;
    ...
    public ODKView(Context context, final FormEntryPrompt[] questionPrompts,
        ...
        if (groups != null && groups.length > 0) {
            ...
            if (intentString != null && intentString.length() != 0) {
                ...
                buttonText = (v != null) ? v : context.getString(com.gic.collect.android.R.string.launch_app);
                v = c.getSpecialFormQuestionText("noAppErrorString");
                errorString = (v != null) ? v : context.getString(com.gic.collect.android.R.string.no_app);
            ...
            if (q instanceof BinaryWidget) {
                if (((BinaryWidget) q).isWaitingForBinaryData()) {
                    try {
                        ...
                        Timber.e(e);
                        ToastUtils.showLongToast(getContext().getString(com.gic.collect.android.R.string.error_attaching_binary_file,
                                        e.getMessage()));
                    }
                    set = true;
                    break;
                    ...
                    switch (prompt.getDataType()) {
                        ...
                        default:
                            throw new RuntimeException(
                                    getContext().getString(com.gic.collect.android.R.string.ext_assign_value_error,
