...
public final class PreferenceKeys {
    ...
    private static HashMap<String, Object> getHashMap() {
        ...
        hashMap.put(KEY_SPLASH_PATH,                Collect.getInstance().getString(com.gic.collect.android.R.string.default_splash_path));
        ...
        hashMap.put(KEY_PROTOCOL,                   Collect.getInstance().getString(com.gic.collect.android.R.string.protocol_odk_default));
        ...
        hashMap.put(KEY_SERVER_URL,                 Collect.getInstance().getString(com.gic.collect.android.R.string.default_server_url));
