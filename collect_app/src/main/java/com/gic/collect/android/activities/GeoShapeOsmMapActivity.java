...
import com.gic.collect.android.widgets.GeoShapeWidget;
...
public class GeoShapeOsmMapActivity extends Activity implements IRegisterReceiver {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.gic.collect.android.R.layout.geoshape_osm_layout);
        setTitle(getString(com.gic.collect.android.R.string.geoshape_title)); // Setting title of the action
        ImageButton saveButton = (ImageButton) findViewById(com.gic.collect.android.R.id.save);
        clearButton = (ImageButton) findViewById(com.gic.collect.android.R.id.clear);

        map = (MapView) findViewById(com.gic.collect.android.R.id.geoshape_mapview);
        ...
        ImageButton layersButton = (ImageButton) findViewById(com.gic.collect.android.R.id.layers);
        ...
        locationButton = (ImageButton) findViewById(com.gic.collect.android.R.id.gps);
        ...
        zoomDialogView = getLayoutInflater().inflate(com.gic.collect.android.R.layout.geoshape_zoom_dialog, null);

        zoomLocationButton = (Button) zoomDialogView.findViewById(com.gic.collect.android.R.id.zoom_location);
        ...
        zoomPointButton = (Button) zoomDialogView.findViewById(com.gic.collect.android.R.id.zoom_shape);
    ...
    private void overlayIntentPolygon(String str) {
        ...
        for (int i = 0; i < (sa.length - 1); i++) {
            ...
            marker.setIcon(ContextCompat.getDrawable(getApplicationContext(), com.gic.collect.android.R.drawable.ic_place_black_36dp));
    ...
    private void showGPSDisabledAlertToUser() {
        ...
        alertDialogBuilder.setMessage(getString(com.gic.collect.android.R.string.gps_enable_message))
                .setCancelable(false)
                .setPositiveButton(getString(com.gic.collect.android.R.string.enable_gps),
        ...
        alertDialogBuilder.setNegativeButton(getString(com.gic.collect.android.R.string.cancel),
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        dialog.cancel();
                    }
    ...
    private void showClearDialog() {
        ...
        builder.setMessage(getString(com.gic.collect.android.R.string.geo_clear_warning))
                .setPositiveButton(getString(com.gic.collect.android.R.string.clear),
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                clearFeatures();
                            }
                        })
                .setNegativeButton(com.gic.collect.android.R.string.cancel, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
    ...
    private void showBackDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage(getString(com.gic.collect.android.R.string.geo_exit_warning))
                .setPositiveButton(getString(com.gic.collect.android.R.string.discard),
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                finish();
                            }
    ...
    public void showZoomDialog() {
        ...
        if (zoomDialog == null) {
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setTitle(getString(com.gic.collect.android.R.string.zoom_to_where));
