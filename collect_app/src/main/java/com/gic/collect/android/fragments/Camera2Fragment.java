...
public class Camera2Fragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(com.gic.collect.android.R.layout.fragment_camera2, container, false);
    }

    @Override
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        textureView = (TextureView) view.findViewById(com.gic.collect.android.R.id.texture);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                ErrorDialog.newInstance(getString(com.gic.collect.android.R.string.request_permission))
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            ...
            ErrorDialog.newInstance(getString(com.gic.collect.android.R.string.camera_error))
                    .show(getChildFragmentManager(), FRAGMENT_DIALOG);
        }
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case com.gic.collect.android.R.id.texture: {
                takePicture();
                break;
            }
        }
    ...
    public static class ConfirmationDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    .setMessage(com.gic.collect.android.R.string.request_permission)
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        @Override
