    ...
    public static class AudioHandler {
        ...
        public void playAudio(Context c) {
            ...
            if (uri == null) {
                ...
                ToastUtils.showLongToast(com.gic.collect.android.R.string.audio_file_error);
                return;
            }
            ...
            if (!audioFile.exists()) {
                ...
                String errorMsg = c.getString(com.gic.collect.android.R.string.file_missing, audioFile);
                Timber.e(errorMsg);
            ...
            try {
                ...
                String errorMsg = c.getString(com.gic.collect.android.R.string.audio_file_invalid, audioFilename);
                Timber.e(errorMsg);
                ToastUtils.showLongToast(errorMsg);
            }
