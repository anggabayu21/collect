...
import com.gic.collect.android.adapters.FileArrayAdapter;
import com.gic.collect.android.application.Collect;
import com.gic.collect.android.listeners.GoogleDriveFormDownloadListener;
import com.gic.collect.android.listeners.TaskListener;
import com.gic.collect.android.logic.DriveListItem;
...
import static com.gic.collect.android.tasks.InstanceGoogleSheetsUploader.REQUEST_ACCOUNT_PICKER;
import static com.gic.collect.android.tasks.InstanceGoogleSheetsUploader.REQUEST_AUTHORIZATION;
import static com.gic.collect.android.tasks.InstanceGoogleSheetsUploader.REQUEST_PERMISSION_GET_ACCOUNTS;
...
public class GoogleDriveActivity extends AppCompatActivity implements
    ...
    private void initToolbar() {
        ...
        setTitle(getString(com.gic.collect.android.R.string.google_drive));
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.gic.collect.android.R.layout.drive_layout);
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(MY_DRIVE_KEY)) {
            ...
            adapter = new FileArrayAdapter(GoogleDriveActivity.this, com.gic.collect.android.R.layout.two_item_image, dl);
            ...
            if (!isDeviceOnline()) {
                createAlertDialog(getString(com.gic.collect.android.R.string.no_connection));
            }
        }
        ...
        rootButton = (Button) findViewById(com.gic.collect.android.R.id.root_button);
        if (myDrive) {
            rootButton.setText(getString(com.gic.collect.android.R.string.go_shared));
        } else {
            rootButton.setText(getString(com.gic.collect.android.R.string.go_drive));
        }
        rootButton.setOnClickListener(this);

        backButton = (Button) findViewById(com.gic.collect.android.R.id.back_button);
        backButton.setEnabled(parentId != null);
        backButton.setOnClickListener(this);

        downloadButton = (Button) findViewById(com.gic.collect.android.R.id.download_button);
        downloadButton.setOnClickListener(this);

        searchText = (EditText) findViewById(com.gic.collect.android.R.id.search_text);
        ...
        searchButton = (ImageButton) findViewById(com.gic.collect.android.R.id.search_button);
    ...
    private void chooseAccount() {
        if (EasyPermissions.hasPermissions(
            ...
            EasyPermissions.requestPermissions(
                    this,
                    getString(com.gic.collect.android.R.string.request_permissions_google_account),
    ...
    void executeSearch() {
        ...
        if (searchString.length() > 0) {
            ...
            ToastUtils.showShortToast(com.gic.collect.android.R.string.no_blank_search);
        }
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (o != null && o.getType() == DriveListItem.DIR) {
            ...
            CheckBox cb = (CheckBox) view.findViewById(com.gic.collect.android.R.id.checkbox);
    ...
    private void getFiles() {
        ...
        alertMsg = getString(com.gic.collect.android.R.string.drive_get_file, messageBuilder.toString());
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            case PROGRESS_DIALOG:
                ...
                progressDialog.setTitle(getString(com.gic.collect.android.R.string.downloading_data));
                progressDialog.setMessage(alertMsg);
                progressDialog.setIndeterminate(true);
                progressDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
                progressDialog.setCancelable(false);
                progressDialog.setButton(getString(com.gic.collect.android.R.string.cancel), loadingButtonListener);
                return progressDialog;
            case GOOGLE_USER_DIALOG:
                AlertDialog.Builder gudBuilder = new AlertDialog.Builder(this);

                gudBuilder.setTitle(getString(com.gic.collect.android.R.string.no_google_account));
                gudBuilder.setMessage(getString(com.gic.collect.android.R.string.google_set_account));
                gudBuilder.setPositiveButton(com.gic.collect.android.R.string.ok, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        finish();
                    }
    ...
    private void createAlertDialog(String message) {
        ...
        alertDialog.setTitle(getString(com.gic.collect.android.R.string.download_forms_result));
        ...
        alertDialog.setButton(getString(com.gic.collect.android.R.string.ok), quitListener);
    ...
    public void taskComplete(HashMap<String, Object> results) {
        ...
        if (currentPath.empty()) {
            if (myDrive) {
                currentPath.add(getString(com.gic.collect.android.R.string.go_drive));
            } else {
                currentPath.add(getString(com.gic.collect.android.R.string.go_shared));
            }
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.gic.collect.android.R.id.root_button:
                getResultsFromApi();
                break;

            case com.gic.collect.android.R.id.back_button:
                backButton.setEnabled(false);
                rootButton.setEnabled(false);
                downloadButton.setEnabled(false);
                toDownload.clear();
            ...
            case com.gic.collect.android.R.id.download_button:
                getFiles();
                break;

            case com.gic.collect.android.R.id.search_button:
                executeSearch();
                break;
        }
    }
    ...
    private class RetrieveDriveFileContentsAsyncTask extends
            ...
            if (rootId == null) {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            createAlertDialog(getString(com.gic.collect.android.R.string.google_auth_io_exception_msg));
                        }
                    });
                }
                if (rootId == null) {
        ...
        protected final void onProgressUpdate(HashMap<String, Object>... values) {
            ...
            if (adapter == null) {
                adapter = new FileArrayAdapter(GoogleDriveActivity.this, com.gic.collect.android.R.layout.two_item_image,
                        dirs);
                listView.setAdapter(adapter);
            } else {
    ...
    private class GetFileTask extends
        ...
        protected final HashMap<String, Object> doInBackground(ArrayList<DriveListItem>... params) {
            ...
            for (int k = 0; k < fileItems.size(); k++) {
                ...
                results.put(fileItem.getName(), Collect.getInstance().getString(com.gic.collect.android.R.string.success));
            }
            return results;
