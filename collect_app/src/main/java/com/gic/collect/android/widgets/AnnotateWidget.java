...
import com.gic.collect.android.activities.DrawActivity;
...
public class AnnotateWidget extends QuestionWidget implements FileWidget {
    ...
    public AnnotateWidget(Context context, FormEntryPrompt prompt) {
        ...
        annotateButton = getSimpleButton(getContext().getString(com.gic.collect.android.R.string.markup_image));
