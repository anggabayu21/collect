...
package com.gic.collect.android.provider;
...
import com.gic.collect.android.database.helpers.FormsDatabaseHelper;
...
public class FormsProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        qb.setTables(FormsDatabaseHelper.FORMS_TABLE_NAME);
    ...
    public synchronized Uri insert(@NonNull Uri uri, ContentValues initialValues) {
        ...
        if (!values.containsKey(FormsProviderAPI.FormsColumns.DISPLAY_SUBTEXT)) {
            ...
            String ts = new SimpleDateFormat(getContext().getString(
                    com.gic.collect.android.R.string.added_on_date_at_time), Locale.getDefault())
                    .format(today);
        ...
        Cursor c = null;
        try {
            c = db.query(FormsDatabaseHelper.FORMS_TABLE_NAME, projection, selection,
        ...
        long rowId = db.insert(FormsDatabaseHelper.FORMS_TABLE_NAME, null, values);
        if (rowId > 0) {
    ...
    public int delete(@NonNull Uri uri, String where, String[] whereArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            case FORMS:
                ...
                count = db.delete(FormsDatabaseHelper.FORMS_TABLE_NAME, where, whereArgs);
                break;
            ...
            case FORM_ID:
                ...
                count = db.delete(
                        FormsDatabaseHelper.FORMS_TABLE_NAME,
    ...
    public int update(Uri uri, ContentValues values, String where,
        ...
        switch (sUriMatcher.match(uri)) {
            case FORMS:
                ...
                count = db.update(FormsDatabaseHelper.FORMS_TABLE_NAME, values, where, whereArgs);
                break;
                    ...
                    if (update != null && update.getCount() > 0) {
                        ...
                        if (values.containsKey(FormsProviderAPI.FormsColumns.DATE)) {
                            ...
                            String ts = new SimpleDateFormat(getContext()
                                    .getString(com.gic.collect.android.R.string.added_on_date_at_time),
