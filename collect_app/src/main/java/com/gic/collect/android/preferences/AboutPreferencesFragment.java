...
import com.gic.collect.android.activities.OpenSourceLicensesActivity;
import com.gic.collect.android.utilities.CustomTabHelper;
...
public class AboutPreferencesFragment extends BasePreferenceFragment implements Preference.OnPreferenceClickListener {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(com.gic.collect.android.R.xml.about_preferences);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getString(com.gic.collect.android.R.string.about_preferences));
    }
        ...
        switch (preference.getKey()) {
            ...
            case KEY_TELL_YOUR_FRIENDS:
                ...
                shareIntent.putExtra(Intent.EXTRA_TEXT,
                        getString(com.gic.collect.android.R.string.tell_your_friends_msg) + " " + GOOGLE_PLAY_URL
                                + APP_PACKAGE_NAME);
                startActivity(Intent.createChooser(shareIntent,
                        getString(com.gic.collect.android.R.string.tell_your_friends)));
                break;
