...
public class ColorPickerDialog extends Dialog {
    ...
    private static class ColorPickerView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawText(getContext().getString(com.gic.collect.android.R.string.ok), 74, 340,
                    paint);
            ...
            canvas.drawText(getContext().getString(com.gic.collect.android.R.string.cancel), 202, 340,
                    paint);
        }
