...
import com.gic.collect.android.tasks.DeleteFormsTask;
import com.gic.collect.android.tasks.DiskSyncTask;
...
import com.gic.collect.android.listeners.DeleteFormsListener;
import com.gic.collect.android.utilities.VersionHidingCursorAdapter;
...
public class FormManagerList extends FormListFragment implements DiskSyncListener,
    ...
    private void setupAdapter() {
        ...
        String[] data = new String[]{FormsProviderAPI.FormsColumns.DISPLAY_NAME, FormsProviderAPI.FormsColumns.DISPLAY_SUBTEXT, FormsProviderAPI.FormsColumns.JR_VERSION};
        int[] view = new int[]{R.id.text1, R.id.text2, R.id.text3};

        listAdapter = new VersionHidingCursorAdapter(
                FormsProviderAPI.FormsColumns.JR_VERSION, getActivity(),
