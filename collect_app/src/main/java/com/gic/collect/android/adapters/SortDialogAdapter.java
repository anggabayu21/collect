...
package com.gic.collect.android.adapters;
...
public class SortDialogAdapter extends RecyclerView.Adapter<SortDialogAdapter.ViewHolder> {
    ...
    public SortDialogAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemLayoutView = LayoutInflater.from(parent.getContext())
                .inflate(com.gic.collect.android.R.layout.sort_item_layout, parent, false);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        if (position == selectedSortingOrder) {
            viewHolder.txtViewTitle.setTextColor(context.getResources().getColor(com.gic.collect.android.R.color.tintColor));
            DrawableCompat.setTint(viewHolder.imgViewIcon.getDrawable(),
                    context.getResources().getColor(com.gic.collect.android.R.color.tintColor));
        } else {
            viewHolder.txtViewTitle.setTextColor(context.getResources().getColor(com.gic.collect.android.R.color.black));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(final View itemLayoutView) {
            ...
            txtViewTitle = (TextView) itemLayoutView.findViewById(com.gic.collect.android.R.id.title);
            imgViewIcon = (ImageView) itemLayoutView.findViewById(com.gic.collect.android.R.id.icon);
        ...
        public void updateItemColor(int selectedSortingOrder) {
            ...
            previousHolder.txtViewTitle.setTextColor(context.getResources().getColor(com.gic.collect.android.R.color.black));
            DrawableCompat.setTintList(previousHolder.imgViewIcon.getDrawable(), null);

            txtViewTitle.setTextColor(context.getResources().getColor(com.gic.collect.android.R.color.tintColor));
            DrawableCompat.setTint(imgViewIcon.getDrawable(), context.getResources().getColor(com.gic.collect.android.R.color.tintColor));
        }
    }
}
