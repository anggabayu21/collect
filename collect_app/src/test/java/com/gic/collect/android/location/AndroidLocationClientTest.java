package com.gic.collect.android.location;
...
public class AndroidLocationClientTest {
    ...
    public void passiveProviderOnlyShouldFailOnHighAndBalancedPriorities() {
        ...
        androidLocationClient.setPriority(LocationClient.Priority.PRIORITY_HIGH_ACCURACY);
        androidLocationClient.start();
        ...
        androidLocationClient.setPriority(LocationClient.Priority.PRIORITY_BALANCED_POWER_ACCURACY);
        androidLocationClient.start();
        ...
        // PASSIVE_PROVIDER enabled:
        androidLocationClient.setPriority(LocationClient.Priority.PRIORITY_LOW_POWER);
        androidLocationClient.start();
        ...
        androidLocationClient.setPriority(LocationClient.Priority.PRIORITY_NO_POWER);
        androidLocationClient.start();
