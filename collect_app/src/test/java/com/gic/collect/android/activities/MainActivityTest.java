...
public class MainActivityTest {
    ...
    public void titleTest() throws Exception {
        Toolbar toolbar = (Toolbar) mainMenuActivity.findViewById(com.gic.collect.android.R.id.toolbar);
        assertEquals(mainMenuActivity.getString(com.gic.collect.android.R.string.main_menu), toolbar.getTitle());
    }
    ...
    public void optionsMenuTest() throws Exception {
        ...
        String menuTitle = mainMenuActivity.getResources().getString(com.gic.collect.android.R.string.about_preferences);
        ...
        menuTitle = mainMenuActivity.getResources().getString(com.gic.collect.android.R.string.general_preferences);
        shadowTitle = menu.getItem(1).getTitle().toString();
        assertEquals(shadowTitle, menuTitle);

        //Test for Admin Settings Menu Title
        menuTitle = mainMenuActivity.getResources().getString(com.gic.collect.android.R.string.admin_preferences);
    ...
    public void dataButtonTest() throws Exception {
        Button dataButton = (Button) mainMenuActivity.findViewById(com.gic.collect.android.R.id.enter_data);

        assertNotNull(dataButton);
        assertEquals(View.VISIBLE, dataButton.getVisibility());
        assertEquals(mainMenuActivity.getString(com.gic.collect.android.R.string.enter_data_button), dataButton.getText());
    ...
    public void reviewDataButtonTest() throws Exception {
        Button reviewDataButton = (Button) mainMenuActivity.findViewById(com.gic.collect.android.R.id.review_data);

        assertNotNull(reviewDataButton);
        assertEquals(View.VISIBLE, reviewDataButton.getVisibility());
        assertEquals(mainMenuActivity.getString(com.gic.collect.android.R.string.review_data_button), reviewDataButton.getText());
    ...
    public void sendDataButtonTest() throws Exception {
        Button sendDataButton = (Button) mainMenuActivity.findViewById(com.gic.collect.android.R.id.send_data);

        assertNotNull(sendDataButton);
        assertEquals(View.VISIBLE, sendDataButton.getVisibility());
        assertEquals(mainMenuActivity.getString(com.gic.collect.android.R.string.send_data_button), sendDataButton.getText());
    ...
    public void viewSentFormButtonTest() throws Exception {
        Button viewSentFormButton = (Button) mainMenuActivity.findViewById(com.gic.collect.android.R.id.view_sent_forms);

        assertNotNull(viewSentFormButton);
        assertEquals(View.VISIBLE, viewSentFormButton.getVisibility());
        assertEquals(mainMenuActivity.getString(com.gic.collect.android.R.string.view_sent_forms), viewSentFormButton.getText());
    ...
    public void getFormButtonTest() throws Exception {
        Button getFormButton = (Button) mainMenuActivity.findViewById(com.gic.collect.android.R.id.get_forms);
        assertNotNull(getFormButton);
        assertEquals(View.VISIBLE, getFormButton.getVisibility());
        assertEquals(mainMenuActivity.getString(com.gic.collect.android.R.string.get_forms), getFormButton.getText());
    }
    ...
    public void manageFilesButtonTest() throws Exception {
        Button manageFilesButton = (Button) mainMenuActivity.findViewById(com.gic.collect.android.R.id.manage_forms);

        assertNotNull(manageFilesButton);
        assertEquals(View.VISIBLE, manageFilesButton.getVisibility());
        assertEquals(mainMenuActivity.getString(com.gic.collect.android.R.string.manage_files), manageFilesButton.getText());
